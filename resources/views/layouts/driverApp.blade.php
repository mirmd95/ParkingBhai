...
$a = Application::all()->where('driver_id',Auth::id())->where('status',1)->count();
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <a class="navbar-brand" href="{{ route('home') }}">
                             ...
                             <a class="navbar-brand" href="{{ route('driver_notifications') }}">
                               {{ 'Notification' }}<b style="color: red;"><?php if($a>0) echo '(',$a,')' ?></b>
                             </a>
                             <a class="navbar-brand" href="{{ route('pendingRequest') }}">
                                {{ 'PendingRequest' }}
                             </a>
                             <a class="navbar-brand" href="{{ route('driver_record') }}">
                                {{ 'Record' }}
                             </a>
